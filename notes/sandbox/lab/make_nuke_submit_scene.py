...
OUT = "P:/projects/opencue_test/render/nuke_sub/"
...
w1["create_directories"].setValue(True)
w1.setInput(0, cb)
grp = nuke.nodes.Group(name="Comp")
grp.begin()
inp = nuke.nodes.Input()
w2 = nuke.nodes.Write(name="WriteB", file=OUT + "b.####.png", file_type="png")
w2["create_directories"].setValue(True)
w2.setInput(0, inp)
grp.end()
grp.setInput(0, cb)
nuke.scriptSaveAs("P:/projects/opencue_test/scenes/nuke_submit_test.nk", overwrite=1)
