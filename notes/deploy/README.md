...
| 機器 | 文件 | 設定檔 |
|---|---|---|
| OpenCue 伺服器 | [`01-伺服器.md`](01-伺服器.md) | `server/` |
| 專職算圖機 | [`02-算圖節點.md`](02-算圖節點.md) | `node/` |
| artist 工作站 | [`02-算圖節點.md`](02-算圖節點.md) ＋ [`03-工作站.md`](03-工作站.md) | `node/` ＋ `client/` |
